...
class TestRandomGamma(TorchioTestCase):
    ...
    def test_with_zero_gamma(self):
        ...
        assert_array_almost_equal(self.sample.t1.data, transformed.t1.data)
    ...
    def test_with_high_gamma(self):
        ...
        transformed = transform(self.sample)
        assert_array_almost_equal(self.sample.t1.data == 1, transformed.t1.data)

    def test_with_low_gamma(self):
        transform = RandomGamma(log_gamma_range=(-100, -100))
        transformed = transform(self.sample)
        assert_array_almost_equal(self.sample.t1.data > 0, transformed.t1.data)
